...
class OpenAIProvider(AIProvider):
    """OpenAI API provider for strategy generation"""
    ...
    def generate_strategy(self, code_analysis: Dict[str, Any], performance_mode: str = 'balanced') -> Dict[str, Any]:
        """Generate confusion strategy using OpenAI API
        ...
        try:
            ...
            response = openai.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert in code obfuscation and security. Generate a comprehensive confusion strategy for Python code."},
...
4. Only return the JSON object, no additional text."""
    ...
    def _parse_strategy(self, content: str) -> Dict[str, Any]:
        """Parse strategy from OpenAI response
